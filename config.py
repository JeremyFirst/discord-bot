...
TRANSCRIPT_HOST = os.getenv("TRANSCRIPT_HOST", "0.0.0.0")
TRANSCRIPT_PORT = int(os.getenv("TRANSCRIPT_PORT", "8080"))
TRANSCRIPT_PUBLIC_URL = os.getenv("TRANSCRIPT_PUBLIC_URL")
